In JSON Web Tokens (JWTs), claims are pieces of information that are contained within the token payload and provide information about the entity (usually a user) and metadata related to the token.
